...
Personal portfolio for Bishal Hona, a product-minded backend engineer who has
gone deep on the infrastructure behind AI products. Built with
...
- **Type**: two voices. **Newsreader** (serif) for human judgment, used big and
  rarely; **Geist Sans / Geist Mono** for the machine on nav, labels, diagrams.
